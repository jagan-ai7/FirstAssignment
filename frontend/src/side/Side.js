    ...
    <>
      <div className="bg-white border-end p-4 overflow-y-auto side-container">
        {friendsToShow.map((user, i) => (
          <div
            className=" flex flex-column align-items-start px-[10px] overflow-hidden text-ellipsis rounded-md hover:scale-[1.05] hover:bg-neutral-950 hover:text-neutral-50 active:scale-[0.98] ring shadow-xl ring-gray-300 hover:ring-0 cursor-pointer "
            key={i}
            onClick={(e) => {
              e.preventDefault();
