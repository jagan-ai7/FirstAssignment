...
export const Register = () => {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            firstName: Yup.string().min(3, "Must be more than 2 characters").max(15, "Must be 15 character or less").required('First Name is required'),
            lastName: Yup.string().min(3, "Must be more than 2 characters").max(15, "Must be 15 character or less").required('Last Name is required'),
            ...
            <form className="form_container">
                ...
                <div style={{ display: "flex", flexDirection: "row", flexWrap: "wrap", gap: "10px", justifyContent: "space-evenly" }}>
                    <div className="inputText_field">
                        <label className="labelText" htmlFor="firstNameText">First Name <span style={{color: "red"}}>*</span></label>
                        <input className="inputText" type="text" name="firstName" placeholder="Enter First Name" {...formik.getFieldProps('firstName')} />
                        {formik.touched.firstName && formik.errors.firstName ? <div className="input_error">{formik.errors.firstName}</div> : null}
                    </div>
                    <div className="inputText_field">
                        <label className="labelText" htmlFor="lastNameText">Last Name <span style={{color: "red"}}>*</span></label>
                        <input className="inputText" type="text" name="lastName" placeholder="Enter Last Name" {...formik.getFieldProps('lastName')} />
                        {formik.touched.lastName && formik.errors.lastName ? <div className="input_error">{formik.errors.lastName}</div> : null}
                    </div>
                    ...
                    <div className="inputText_field">
                        ...
                        <div className="password_container">
                            <input className="password_class" type={showPassword ? "text" : "password"} name="password" placeholder="Enter Password" {...formik.getFieldProps('password')} />
                ...
                <button className="submitButton" onClick={formik.handleSubmit} type="submit">Register</button>
            </form>
        </div>
    )
}